...
- (void)viewDidLoad {
    ...
    self.searchBtn = [BlueGradientButton setGradient:self.searchBtn widthBtn:80.0];
...
- (IBAction)tapCalendar:(UILongPressGestureRecognizer *)sender {
    ...
    if (sender.state == UIGestureRecognizerStateEnded) {
        LPSearchByDateViewController *searchByDateVC = [[LPSearchByDateViewController alloc] initWithNibName:@"LPSearchByDateViewController" bundle:nil];
        [self.navigationController pushViewController:searchByDateVC animated:YES];
    }
}
...
- (IBAction)tapMap:(UILongPressGestureRecognizer *)sender {
    ...
    if (sender.state == UIGestureRecognizerStateEnded) {
        LPSearchResultMapViewController *searchResultMapVC = [[LPSearchResultMapViewController alloc] initWithNibName:@"LPSearchResultMapViewController" bundle:nil];
        [self.navigationController pushViewController:searchResultMapVC animated:YES];
    }
}
